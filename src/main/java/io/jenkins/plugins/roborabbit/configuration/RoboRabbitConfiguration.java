package io.jenkins.plugins.roborabbit.configuration;
...
import io.jenkins.plugins.roborabbit.consumer.Messages;
...
import io.jenkins.plugins.roborabbit.consumer.utils.Validators;
import io.jenkins.plugins.roborabbit.consumer.watchdog.ReconnectTimer;
 ...
 */
@Extension
public class RoboRabbitConfiguration extends GlobalConfiguration {

    private static final Logger LOGGER = Logger.getLogger(RoboRabbitConfiguration.class.getName());
    ...
    public RoboRabbitConfiguration() {
        load();
    }
    ...
    public RoboRabbitConfiguration(boolean enableConsumer, String serviceUri, String credentialsId, long watchdogPeriod, List<RabbitmqConsumeItem> consumeItems, boolean enableDebug) {
    ...
    public static RoboRabbitConfiguration get() {
        return ExtensionList.lookupSingleton(RoboRabbitConfiguration.class);
    }
    ...
    public StandardUsernamePasswordCredentials getCredentials() {
        if(Objects.isNull(credentialsId)) {
            Logger.getLogger(RoboRabbitConfiguration.class.getName()).warning("Credentials ID is null");
            return null;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoboRabbitConfiguration)) return false;
        RoboRabbitConfiguration that = (RoboRabbitConfiguration) o;
